...
1. Navigate to /root/GPS/gps_sender.py , open the file in editor
...
4. You will see something like what is below. You are looking for the underlined parts that are the device ID. Take note of it and compare it to the device listed in the script. If it is different, then the ttyAMA0 change it to match.
